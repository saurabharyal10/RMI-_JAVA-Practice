...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=106682&cbuster=[CACHE_BUSTER]&pubUrl=https%3A%2F%2Fwww.javatpoint.com%2FRMI&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&schain=1.0,1!adpushup.com,e224c2b5124a33f1f8d127266731a85e,1&cbuster=1648273703',
					origQString: 's=106682&cbuster=[CACHE_BUSTER]&pubUrl=https%3A%2F%2Fwww.javatpoint.com%2FRMI&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&schain=1.0,1!adpushup.com,e224c2b5124a33f1f8d127266731a85e,1',
					placementId: 106682,
					x: 640,
					y: 440,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"96.0.4664.45","browserVersionMajor":"96","browserVersionMinor":"0","chromeVersion":"96"},"browser":"chrome","os":"linux","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'XX',
					dmaCode: 0,
					dynamicSetup: [],
